  ...
  zh: {
    ...
    settings: {
      ...
      importErrors: {
        ...
        readFailed: '无法读取所选文件',
        wrongFileType: '文件类型不匹配，请选择 ZTerm 导出的会话或设置 JSON',
        unsupportedVersion: '不支持的导出文件版本',
        invalidPayload: '导出文件内容格式无效',
  ...
  en: {
    ...
    settings: {
      ...
      importErrors: {
        ...
        wrongFileType: 'Wrong file type—use a ZTerm sessions or settings export JSON',
        unsupportedVersion: 'Unsupported export file version',
        invalidPayload: 'Invalid export file contents',
