 ...
 */
export function assertSftpLocalFilePathAllowedForRoots(localPath, roots, kind) {
 ...
 */
export function assertSftpLocalDirAllowedForRoots(localDir, roots, kind) {
 ...
 */
export function safeJoinLocalDownloadPathForRoots(localDir, name, roots, kind) {
