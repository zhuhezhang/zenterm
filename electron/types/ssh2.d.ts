/**
 * ssh2 无官方类型；供 tsconfig `paths` 映射，运行时仍加载 node_modules/ssh2。
 * 自 `electron/types/shims.d.ts` 的 `declare module 'ssh2'` 迁出。
 */
...
/** CommonJS 默认导出（`import ssh2 from 'ssh2'` → `ssh2.utils` 等） */
declare const ssh2: {
